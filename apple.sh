...
Applications developed under this Agreement can be distributed in four ways: (1) through the App Store, if selected by Apple, (2) through the VPP/B2B Program Site, if selected by Apple, (3) on a limited basis for use on Registered Devices (as defined below), and (4) for beta testing through Apple’s TestFlight Program.

Applications that meet Apple's Documentation and Program Requirements may be submitted for consideration by Apple for distribution via the App Store, VPP/B2B Program Site, or for beta testing through Apple’s TestFlight Program. If submitted by You and selected by Apple, Your Applications will be digitally signed by Apple and distributed, as applicable. Distribution of free (no charge) Applications (including those that use the In-App Purchase API for the delivery of free content) will be subject to the distribution terms contained in Schedule 1 to this Agreement.  If You would like to distribute Applications for which You will charge a fee or would like to use the In-App Purchase API for the delivery of fee-based content, You must enter into a separate agreement with Apple (“Schedule 2”). If You would like to distribute Custom B2B Applications via the VPP/B2B Program Site, You must enter into a separate agreement with Apple (“Schedule 3”). You may also create Passes (as defined below) for use on Apple-branded products running the iOS under this Agreement and distribute such Passes for use by Passbook.
...
“Apple Maps Service” means the mapping platform and Map Data provided by Apple via the Map Kit API for iOS version 6 or later and for use by You only in connection with Your Applications. 

“Apple Pay APIs” means the Documented APIs that enable end-users to send payment information they have stored on their iOS Product (e.g., device account number, billing address, etc.) to an Application to be used in payment transactions made through the Application, and includes other payment-related functionality as described in the Documentation.

“Apple Push Notification” or “APN” means the Apple Push Notification service that Apple may provide to You to enable You to transmit Push Notifications to Your Application or for use as otherwise permitted herein.
...
“Apple Subsidiary” means a corporation at least fifty percent (50%) of whose outstanding shares or securities (representing the right to vote for the election of directors or other managing authority) are owned or controlled, directly or indirectly, by Apple, and that is involved in the operation of or otherwise affiliated with the App Store, VPP/B2B Program Site or TestFlight Program, including without limitation Apple Pty Limited, iTunes S.à.r.l., and iTunes K.K.

“Application” means one or more software programs (including extensions, media, and Libraries that are enclosed in a single software bundle) developed by You in compliance with the Documentation and the Program Requirements, for distribution under Your own trademark or brand, and for specific use with an iOS Product, including bug fixes, updates, upgrades, modifications, enhancements, supplements to, revisions, new releases and new versions of such software programs.  

“Authorized Developers” means Your employees and contractors, members of Your organization or, if You are an educational institution, Your faculty and staff who (a) each have an active and valid Registered Apple Developer account with Apple, (b) have a demonstrable need to know or use the Apple Software in order to develop and test Covered Products, and (c) to the extent such individuals will have access to Apple Confidential Information, each have written and binding agreements with You to protect the unauthorized use and disclosure of such Apple Confidential Information. 
...
“Beta Testers” means end-users whom You have invited to sign up for Apple’s TestFlight Program in order to test pre-release versions of Your Application and who have accepted the terms and conditions of the TestFlight Application.

“CloudKit APIs” means the Documented APIs that enable Your Applications, Mac App Store applications associated with Your developer account, and/or Your end-users (if You permit them) to read, write, query and/or retrieve structured data from public and/or private containers in iCloud.

“Covered Products” means Your Applications, Libraries, Passes, Safari Extensions and/or OS X Website Push Notifications developed under this Agreement.

“Custom B2B Application” means a Licensed Application that is customized by You for use by a specific VPP Customer or group of VPP Customers and that is selected and digitally signed by Apple for distribution through the VPP/B2B Program Site.
...
“Game Center” means the gaming community service and related APIs provided by Apple for use by You in connection with Your Applications and/or Your Mac App Store applications that are associated with Your developer account. The Game Center may consist of an Apple confidential, pre-release version of the Game Center service or a production, commercially-available version of such service. 
...
“HomeKit Accessory Protocol” means the proprietary protocol licensed by Apple under Apple’s MFi Program that enables home accessories designed to work with the HomeKit APIs (e.g., lights, locks) to communicate with iOS Products.
...
“iCloud Storage APIs” means the APIs that allow storage and/or retrieval of user-generated documents and other files, and allow storage and/or retrieval of key value data (e.g., a list of stocks in a finance App, settings for an App) for Applications and Multi-Platform Software through the use of iCloud.  
...
"iOS" means the iOS operating system software provided by Apple for use by You only in connection with Your Application development and testing, which, from time to time during the Term, may consist of an Apple confidential, pre-release version of the iOS operating system software or a gold master "GM" production, commercially-available version of the iOS operating system software (or any successor thereto).

“iOS Accessory” means a non-Apple branded hardware device that interfaces, communicates, or otherwise interoperates with or controls an iOS Product through the iPod Accessory Protocol.

“iOS Product” means an Apple-branded product that runs the iOS.

“iOS SDK” (Software Development Kit) means the Documentation, software (source code and object code), applications, sample code, simulators, tools, libraries, APIs, data, files, and materials provided by Apple for use by You in connection with Your Application, Library or Pass development, and includes any Updates that may be provided by Apple to You pursuant to this Agreement. 
...
“Library” means a code module that cannot be installed or executed separately from an Application and that is developed by You in compliance with the Documentation and Program Requirements only for use with iOS Products.  
...
“MFi Licensing Program” means a separate Apple program that offers developers, among other things, a license to incorporate or use certain Apple technology in or with hardware accessories or devices for purposes of interfacing, communicating or otherwise interoperating with or controlling iOS Products. 

“Map Data” means any content, data or information provided through the Apple Maps Service including, but not limited to, imagery, terrain data, latitude and longitude coordinates, points of interest and traffic data. 

“Map Kit API” means the Documented API that enables You to add mapping features or functionality to Applications.  

“Multi-Platform Software” means other versions of Your software applications (i) that have the same title and substantially equivalent features and functionality as Your Licensed Application and that are made available by You for use on supported versions of OS X and/or supported versions of Windows (as identified in the Documentation), and (ii) that update data with Your Licensed Application through the use of iCloud.
...
“Pass Type ID” means the combination of an Apple-issued certificate and Push Application ID that is used by You to sign Your Passes and/or communicate with the APN.
...
“Passbook” means Apple’s installed iOS application that has the ability to store and display Passes for use on iOS Products. 

“Program” means the overall iOS development, testing, digital signing, and distribution program contemplated in this Agreement, including any services provided hereunder.
...
“Push Notification” or “OS X Website Push Notification” means a message, including any content or data therein, that You transmit to end-users and that is delivered in Your Application, to Your Pass within Passbook, and/or in the case of OS X, to the OS X desktop of users of Your Site who have opted in to receive such messages through Safari on OS X.

"Registered Devices" means iOS Products owned or controlled by You, or owned by individuals who are affiliated with You, that You have specifically registered with Apple under this Program.

“Safari Extensions” means one or more software extensions developed by You under this Agreement only for use with Safari on OS X in compliance with Section 5.
...
“TestFlight Application” means Apple’s iOS application that enables the distribution of pre-release versions of Your Applications to a limited number of Your Authorized Developers and to a limited number of Beta Testers (as specified in iTunes Connect) through the TestFlight Program.

“TestFlight Program” means Apple’s iOS beta testing program for pre-release Applications made available through Apple’s TestFlight Application.
...
“Volume Purchase Program” or “VPP” means an Apple program that offers the ability to obtain Custom B2B Applications and make volume purchases of Licensed Applications. 

“VPP/B2B Program Site” means an electronic store and its storefronts branded, and owned and/or controlled by Apple or an affiliate of Apple, and that is only accessible to VPP Customers. 
...
(a)  Install a reasonable number of copies of the Apple Software on Apple-branded computers owned or controlled by You, to be used internally by You or Your Authorized Developers for the sole purpose of developing or testing Covered Products, except as otherwise expressly permitted in this Agreement;
...
(c)  Install one (1) copy of the iOS and a Provisioning Profile on each of Your Authorized Test Devices, up to the number of Authorized Test Devices that You have registered and acquired licenses for, to be used internally by You or Your Authorized Developers for the sole purpose of developing and testing Your Applications, except as otherwise expressly permitted in this Agreement; and
...
(d) You will be solely responsible for all costs, expenses, losses and liabilities incurred, and activities undertaken by You and Authorized Developers in connection with the Apple Software and services, the Registered Devices, Your Covered Products and Your related development and distribution efforts, including, but not limited to, any related development efforts, network and server equipment, Internet service(s), or any other hardware, software or services used by You in connection with Your use of any services; 
...
(b) You will not use the Apple Software or any services for any unlawful or illegal activity, nor to develop any Covered Product, which would commit or facilitate the commission of a crime, or other tortious, unlawful or illegal act;
...
(e) You will not, through use of the Apple Software, Apple-issued certificates, services or otherwise, create any Covered Product or other code or program that would disable, hack or otherwise interfere with the Security Solution, or any security, digital signing, digital rights management, verification or authentication mechanisms implemented in or by iOS, the Apple Software, or any services, or other Apple software or technology, or enable others to do so; 
...
(i) Safari Extensions signed with an Apple-issued certificate may be distributed to Your end-users in accordance with the terms of this Agreement, including Section 5.

3.3   Program Requirements 
Any Application developed using this Apple Software must meet all of the following criteria and requirements, as they may be modified by Apple from time to time.  Libraries and Passes are subject to the same criteria:
...
3.3.3 Without Apple’s prior written approval or as permitted under Section 3.3.25 (In-App Purchase API), an Application may not provide, unlock or enable additional features or functionality through distribution mechanisms other than the App Store or VPP/B2B Program Site.
...
3.3.13    For Applications compiled for any iOS version providing access to the Ad Support APIs:
...
3.3.17    If Your Application uses or accesses the Map Kit API from a device running iOS version 6 or later, Your Application will access and use the Apple Maps Service. All use of the Map Kit API and Apple Maps Service will be in accordance with the terms of this Agreement  (including the Program Requirements) and Attachment 6 (Additional Terms for the use of the Apple Maps Service).  If Your Application uses or accesses the Map Kit API from a device running iOS version 5 or earlier, Your Application will access and use the Google Mobile Maps (GMM) service.  Such use of the GMM Service is subject to Google’s Terms of Service which are set forth at:  http://code.google.com/apis/maps/terms/iPhone.html.  If You do not accept such Google Terms of Service, including, but not limited to all limitations and restrictions therein, You may not use the GMM service in Your Application, and You acknowledge and agree that such use will constitute Your acceptance of such Terms of Service.
...
3.3.20    Applications may be rejected if they contain content or materials of any kind (text, graphics, images, photographs, sounds, etc.) that in Apple’s reasonable judgment may be found objectionable or inappropriate, for example, materials that may be considered obscene, pornographic, or defamatory. 
...
3.3.26    If You choose to use the Advertising API in Your Application, then You must enter into a separate written agreement with Apple and/or an Apple Subsidiary before any distribution of Your Licensed Application may take place via the App Store, VPP/B2B Program Site, or TestFlight Program. 
...
3.3.28    You will fulfill any applicable regulatory requirements, including full compliance with all applicable laws, regulations, and policies related to the manufacturing, marketing, sale and distribution of Your Application in the United States, and in particular the requirements of the U.S. Food and Drug Administration ("FDA") as well as other U.S. regulatory bodies such as the FAA and FCC, and the laws, regulations and policies of any other applicable regulatory bodies in any countries or territories where You use or make Your Application available. However, You agree that You will not seek any regulatory marketing permissions or make any determinations that may result in any Apple products being deemed regulated or that may impose any obligations or limitations on Apple.  By submitting Your Application to Apple for selection for distribution, You represent and warrant that You are in full compliance with any applicable laws, regulations, and policies, including but not limited to all FDA laws, regulations and policies, related to the manufacturing, marketing, sale and distribution of Your Application in the United States, as well as in other countries or territories where You plan to make Your Application available. You also represent and warrant that You will market Your Application only for its cleared or approved intended use/indication for use, and only in strict compliance with applicable regulatory requirements. Upon Apple’s request, You agree to promptly provide any such clearance documentation to support the marketing of Your Application. If requested by the FDA or by another government body that has a need to review or test Your Application as part of its regulatory review process, You may provide Your Application to such entity for review purposes.  You agree to promptly notify Apple in accordance with the procedures set forth in Section 15.5 of any complaints or threats of complaints regarding Your Application in relation to any such regulatory requirements, in which case Apple may remove Your Application from distribution.  
...
3.3.31    All use of Push Notifications via the APN or Local Notifications must be in accordance with the terms of this Agreement (including the Program Requirements) and Attachment 1 (Additional Terms for Apple Push Notification service and Local Notifications).
...
3.3.34    Your development of Passes, and use of the Pass Type ID and Passbook under this Agreement, must be in accordance with the terms of this Agreement (including the Program Requirements) and Attachment 5 (Additional Terms for Passes).
...
3.3.36    If Your Application accesses the Twitter service through the Twitter API, such access is subject to Twitter terms of service set forth at: http://dev.twitter.com.  If You do not accept such Twitter terms of service, including, but not limited to all limitations and restrictions therein, You may not access the Twitter service in Your Application through the use of the Twitter API, and You acknowledge and agree that such use will constitute Your acceptance of such terms of service.  
...
3.3.38    Applications that include extensions in the Application bundle must provide some functionality beyond just the extensions (e.g., help screens, additional settings). In addition:

-  Such extension functionality may not be used for purposes of advertising, product promotion, or direct marketing or for providing any In-App Purchase offers to an end-user (e.g., an extension for a news App could show the latest headlines in “At a Glance” but could not show ads for a game App); 

-  Extensions may not block the full screen of an iOS Product or redirect, obstruct or interfere in an undisclosed or unexpected way with a user’s use of another developer’s application or any Apple-provided functionality or service;

-  Extensions may operate only in Apple-designated areas of iOS as set forth in the Documentation; 

-  Extensions that provide keyboard functionality must be capable of operating independent of any network access and must include Unicode characters (vs. pictorial images only); and  
...
3.3.39    Your Application must not access the HealthKit APIs unless it is primarily designed to provide health and/or fitness services, and this usage is clearly evident in Your marketing text and user interface.  In addition:
...
-  You must not use the HealthKit APIs, or any information obtained through the HealthKit APIs, to disclose or provide an end-user’s health and/or fitness information to a third party without express end-user consent, and then only for purposes of enabling the third party to provide health and/or fitness services.  For example, You must not share or sell an end-user’s health information collected through the HealthKit APIs to advertising platforms, data brokers or information resellers. For clarity, You may allow end-users to consent to share their data with third parties for medical research purposes.

-  You agree to clearly disclose to end-users how You and Your Application will be using their health and/or fitness information and to use it only as expressly consented to by the end-user and as expressly permitted herein.  
...
3.3.42        Your Application may use the Apple Pay APIs solely for the purpose of facilitating payment transactions that are made through Your Application, and only for the purchase of goods and services that are to be used outside of any iOS Product.  For clarity, nothing in this Section 3.3.42 supplants any of the rules or requirements for the use of the In-App Purchase API, including but not limited to Section 3.3.3 and the guidelines.  In addition:
...
-  You agree to store any private keys provided to You as part of Your use of the Apple Pay APIs in a secure manner (e.g., encrypted on a server) and in accordance with the Documentation.  You agree not to store any end-user payment information in an unencrypted manner on an iOS Product.  For clarity, You may not decrypt any such end-user payment information on an iOS Product.

-  You agree not to call the Apple Pay APIs or otherwise attempt to gain information through the Apple Pay APIs for purposes unrelated to facilitating end-user payment transactions.  For example, if You receive an end-user’s zip code through the Apple Pay APIs before an order is submitted, then You agree to use such information only for purposes of calculating tax and shipping for the transaction and not to use or retain it for any other purposes.
...
All Applications must be signed with an Apple-issued certificate in order to be installed on Registered Devices or submitted to Apple.  All Passes must be signed with a Pass Type ID to be recognized and accepted by Passbook.  All Safari Extensions must be signed with an Apple-issued certificate to run in Safari on OS X. You must use a Website ID to send OS X Website Push Notifications to the OS X desktop of users who have opted in to receive such Notifications for Your Site through Safari on OS X.  

During the Term of this Agreement, You may obtain development-related digital certificates from Apple, subject to a maximum number as reasonably determined by Apple, that will allow Your Application and Your Pass to be installed and tested on Authorized Test Devices. You may also obtain, during the Term, one or more production digital certificates from Apple, subject to a maximum number as reasonably determined by Apple, to be used for the sole purpose of signing Your Application(s) prior to submission of Your Application to Apple or limited distribution of Your Application for use on Registered Devices.  You may also obtain Apple-issued certificates to sign Your Safari Extensions for distribution purposes as set forth herein.

In relation to this, You represent and warrant to Apple that: (a) You will not take any action to interfere with the normal operation of any Apple-issued digital certificates or Provisioning Profiles; (b) You are solely responsible for preventing any unauthorized person from having access to Your digital certificates and corresponding private keys and You will use best efforts to safeguard Your digital certificates and corresponding private keys from compromise; (c) You agree to immediately notify Apple in writing if You have any reason to believe there has been a compromise of any of Your digital certificates or corresponding private keys; (d) You will not provide or transfer Apple-issued digital certificates provided under this Program to any third party, nor use Your digital certificate to sign any third party's application, pass, extension or site, except when providing them to a contractor who is developing an Application, Pass, Safari Extension or Site for You in compliance with the terms of this Agreement; and (e) You will use Apple-issued certificates provided under this Program exclusively for the purpose of signing Your Passes, signing Your Safari Extensions, signing Your Site’s registration bundle, accessing the APN service, and/or signing Your Applications for testing, submission to Apple and/or for limited distribution for use on Registered Devices as contemplated under this Program, and only in accordance with this Agreement.   

You further represent and warrant to Apple that the licensing terms governing Your Application, Your Safari Extension, Your Site’s registration bundle and/or Your Pass, or governing any third party code or FOSS included therein, will be consistent with and not conflict with the digital signing or content protection aspects of the Program or any of the terms, conditions or requirements of the Program or this Agreement. In particular, such licensing terms will not purport to require Apple (or its agents) to disclose or make available any of the keys, authorization codes, methods, procedures, data or other information related to the Security Solution, digital signing or digital rights management mechanisms utilized as part of the Program. If You discover any such inconsistency or conflict, You agree to immediately notify Apple of it and will cooperate with Apple to resolve such matter.  You acknowledge and agree that Apple may immediately cease distribution of any affected Licensed Applications or Passes, and may refuse to accept any subsequent Application or Pass submissions from You until such matter is resolved to Apple’s reasonable satisfaction. 

5.2   Additional Safari Extension Requirements
If You would like to distribute Your Safari Extension signed with an Apple-issued digital certificate, then You agree to the following requirements for such Safari Extension, as they may be modified by Apple from time to time:
...
(c) select and digitally sign Your Application for distribution via the App Store, VPP/B2B Program Site, or TestFlight Program.

Apple shall not be responsible for any costs, expenses, damages, losses (including without limitation lost business opportunities or lost profits) or other liabilities You may incur as a result of Your Application development, use of this Apple Software, use of any services, certificates or APIs provided hereunder, or participation in the Program, including without limitation the fact that Your Application may not be selected for distribution via the App Store or VPP/B2B Program Site. You will be solely responsible for developing Applications that are safe, free of defects in design and operation, and comply with applicable laws and regulations. You will also be solely responsible for any documentation and end-user customer support and warranty of Your Applications. The fact that Apple may have reviewed, tested, approved or selected an Application will not relieve You of any of these responsibilities.

7.    Distribution of Applications and Libraries
Applications:  
Applications developed under this Agreement may be distributed in four ways: (1) through the App Store, if selected by Apple, (2) through the VPP/B2B Program Site, if selected by Apple, (3) through Ad Hoc distribution in accordance with Section 7.2, and (4) for beta testing through Apple’s TestFlight Program in accordance with Section 7.3.
...
If Your Application qualifies as a Custom B2B Application, then You must enter into a separate agreement (Schedule 3) with Apple and/or an Apple Subsidiary before any distribution of Your Custom B2B Application to VPP Customers may take place via the VPP/B2B Program Site.  To the extent that You enter (or have previously entered) into Schedule 2 or Schedule 3 with Apple and/or an Apple Subsidiary, the terms of Schedule 2 or 3 will be deemed incorporated into this Agreement by this reference.

When an end-user installs Your Licensed Application, Apple will provide You with a transaction receipt signed with an Apple-issued certificate.  It is Your responsibility to verify that such certificate and receipt were issued by Apple, as set forth in the Documentation.  You are solely responsible for Your decision to rely on any such certificates and receipts. YOUR USE OF OR RELIANCE ON SUCH CERTIFICATES AND RECEIPTS IN CONNECTION WITH A PURCHASE OF AN APPLICATION IS AT YOUR SOLE RISK.  APPLE MAKES NO WARRANTIES OR REPRESENTATIONS, EXPRESS OR IMPLIED, AS TO MERCHANTABILITY OR FITNESS FOR ANY PARTICULAR PURPOSE, ACCURACY, RELIABILITY, SECURITY, OR NON-INFRINGEMENT OF THIRD PARTY RIGHTS WITH RESPECT TO SUCH DIGITAL CERTIFICATES AND RECEIPTS.  You agree that You will only use such receipts and certificates in accordance with the Documentation, and that You will not interfere or tamper with the normal operation of such digital certificates or receipts, including but not limited to any falsification or other misuse.
...
You may use the TestFlight Program for internal distribution of pre-release versions of Your Applications to a limited number of Your Authorized Developers, but solely for their use in testing and developing Your Applications.  Apple reserves the right to require You to cease distribution of such Applications to Your Authorized Developers through the TestFlight Program, or to any particular Authorized Developer, at any time in its sole discretion. 

B.    Distribution to Beta Testers
You may use the TestFlight Program for external distribution of pre-release versions of Your Applications to a limited number of Beta Testers (as specified in iTunes Connect), but solely for their testing and evaluation of such pre-release versions of Your Applications.  You may not charge Your Beta Testers fees of any kind to participate in Apple’s TestFlight Program or for the use of any such pre-release versions.  Further, You may not use the TestFlight Program for purposes that are not related to improving the quality, performance, or usability of pre-release versions of Your Application (e.g., continuous distribution of demo versions of Your Application in an attempt to circumvent the App Store or providing trial versions of Your Applications for purposes of soliciting favorable App Store ratings are prohibited uses).  Further, if Your Application is primarily intended for children, You must verify that Your Beta Testers are of the age of majority in their jurisdiction. If You choose to add Beta Testers to the TestFlight Program, then You are assuming responsibility for any invitations sent to such end-users and for obtaining their consent to contact them. If a Beta Tester requests that You stop contacting them (either through the TestFlight Program or otherwise), then You agree to promptly do so.

C.    Use of TestFlight Program Information
To the extent that the TestFlight Program provides You with beta analytics information about Your Authorized Developer’s or Beta Tester’s use of pre-release versions of Your Application (e.g., installation time, frequency of an individual’s use of an App, etc.) and/or other related information, You agree to use such data solely for purposes of improving Your Applications and related products.  You agree not to provide such information to any third parties (except for a third-party service provider who is assisting You in processing and analyzing such data on Your behalf and who is not permitted to use it for any other purpose or disclose it to any other party).  For clarity, You must not aggregate (or permit any third-party to aggregate) beta analytics information provided to You by Apple for Your Applications as part of this TestFlight Program with other developers’ beta analytics information, or contribute such information to a repository for cross-developer beta analytics information.  Further, You must not use any beta analytics information provided through the TestFlight Program for purposes of de-anonymizing information obtained from or regarding a particular device or end-user outside of the TestFlight Program (e.g., You may not attempt to connect data gathered through the TestFlight Program for a particular end-user with information that is provided in an anonymized form through Apple’s analytics service).   

Libraries:

7.4   Distribution of Libraries for use with iOS Products only
You may develop Libraries using the iOS SDK under this Agreement, provided any such Libraries are developed and distributed solely for use with an iOS Product, and You limit use of such Libraries only to use with iOS Products. If Apple determines that Your Library is not designed for use only with iOS Products, then Apple may require You to cease distribution of Your Library at any time, and You agree to promptly cease all distribution of such Library upon notice from Apple and cooperate with Apple to remove any remaining copies of such Library.  

7.5   No Other Distribution Authorized Under this Agreement   
Except for the distribution of freely available Licensed Applications through the App Store or VPP/B2B Program Site in accordance with Section 7.1, the distribution of Applications for use on Registered Devices as set forth in Section 7.2 (Ad Hoc Distribution), the distribution of Applications for beta testing through Apple’s TestFlight Program as set forth in Section 7.3, the distribution of Libraries in accordance with Section 7.4, the distribution of Passes in accordance with Attachment 5, the delivery of OS X Website Push Notifications on OS X, and the distribution of Safari Extensions on OS X, no other distribution of programs or applications developed using the Apple Software is authorized or permitted hereunder.  In the absence of a separate agreement with Apple, You agree not to distribute Your Application to third parties via other distribution methods or to enable or permit others to do so.  You agree to distribute Your Covered Products only in accordance with the terms of this Agreement.  

8.    Revocation
You understand and agree that Apple may cease distribution of Your Licensed Application(s) and/or Licensed Application Information or revoke the Apple-issued digital certificates issued to You hereunder at any time.  By way of example only, Apple might choose to do this if at any time:
...
(d) Apple has reason to believe that Your Covered Product damages, corrupts, degrades, destroys or otherwise adversely affects the devices it operates on, or any other software, firmware, hardware, data, systems, or networks accessed or used by such products;
...
(a) if You or any of Your Authorized Developers fail to comply with any term of this Agreement other than those set forth below in this Section 12.2 and fail to cure such breach within 30 days after becoming aware of or receiving notice of such breach;
...
(c)   Privacy Policy.  Data collected pursuant to this Section 15.2 will be treated in accordance with Apple’s Privacy Policy, which is incorporated by reference into this Agreement and which can be viewed at http://www.apple.com/legal/privacy. 

15.3  Assignment; Relationship of the Parties. This Agreement may not be assigned, nor may any of Your obligations under this Agreement be delegated, in whole or in part, by You by operation of law, merger, or any other means without Apple’s express prior written consent and any attempted assignment without such consent will be null and void. Except for the agency appointment as specifically set forth in Schedule 1 (if applicable), this Agreement will not be construed as creating any other agency relationship, or a partnership, joint venture, fiduciary duty, or any other form of legal association between You and Apple, and You will not represent to the contrary, whether expressly, by implication, appearance or otherwise. This Agreement is not for the benefit of any third parties.
...
15.11 Entire Agreement; Governing Language. This Agreement constitutes the entire agreement between the parties with respect to the use of the Apple Software licensed hereunder and supersedes all prior understandings and agreements regarding its subject matter, including the iOS SDK Agreement (clickwrap) accompanying the iOS SDK. This Agreement may be modified only: (a) by a written amendment signed by both parties, or (b) to the extent expressly permitted by this Agreement (for example, by Apple by written or email notice to You).  Any translation of this Agreement is done for local requirements and in the event of a dispute between the English and any non-English version, the English version of this Agreement shall govern.  If You are located in the province of Quebec, Canada or are a government organization within France, then the following clause applies to You: The parties hereby confirm that they have requested that this Agreement and all related documents be drafted in English. Les parties ont exigé que le présent contrat et tous les documents connexes soient rédigés en anglais.
...
1.3   You will only use information provided by the Game Center service as necessary for providing services and functionality for Your Applications as well as any Mac App Store applications that You have associated with Your developer account.  For example, You will not host or export any such information to a third party service.  Further, You agree not to transfer or copy any user information or data (whether individually or in the aggregate) obtained through the Game Center service to a third party except as necessary for providing services and functionality for Your Applications (and Your Mac App Store applications), and then only with express user consent and only if not otherwise prohibited in this Agreement. 
...
2.3   You will not transmit, store or otherwise make available any material that contains viruses or any other computer code, files or programs that may harm, disrupt or limit the normal operation of the Game Center or an iOS Product.
...
2.6   To the extent that Apple permits You to manage certain Game Center features and functionality for Your Application through iTunes Connect (e.g., the ability to block fraudulent users or eliminate suspicious leaderboard scores from Your Application’s leaderboard), You agree to use such methods only when You have a reasonable belief that such users or scores are the result of misleading, fraudulent, improper, unlawful or dishonest acts.
...
4.    Additional Liability Disclaimer.  APPLE SHALL NOT BE LIABLE FOR ANY DAMAGES OR LOSSES ARISING FROM ANY INTERRUPTIONS TO THE GAME CENTER OR ANY SYSTEM FAILURES, NETWORK ATTACKS, SCHEDULED OR UNSCHEDULED MAINTENANCE, OR OTHER INTERRUPTIONS. 

Attachment 4
(to the Agreement)
Additional Terms for the use of iCloud

The following terms are in addition to the terms of the Agreement and apply to Your use of the iCloud service for software development and testing in connection with Your Application, any Mac App Store applications that You have associated with Your developer account, or Multi-Platform Software.  If You receive access to a beta trial for the end-user iCloud service, then Your usage as an end-user of the pre-release iCloud service will be subject to the terms accompanying such beta trial in addition to the terms of this Agreement. You may not use the pre-release iCloud Storage APIs, CloudKit APIs or iCloud service in Your Licensed Applications, Mac App Store applications or Multi-Platform Software until it is publicly released by Apple.  

1.    Use of iCloud 

1.1   Your Applications, Mac App Store applications, and/or Multi-Platform Software may access the iCloud service only if You have been assigned an Entitlement by Apple. You agree not to access the iCloud service, or any content, data or information contained therein, other than through the iCloud Storage APIs, CloudKit APIs or via the CloudKit dashboard provided as part of the Program.  You agree not to share Your Entitlement with any third party or use it for any purposes not expressly permitted by Apple. You agree to use the iCloud service, the iCloud Storage APIs, and the CloudKit APIs only as expressly permitted by this Agreement and the iCloud Documentation, and in accordance with all applicable laws and regulations.

1.2   You understand that You will not be permitted to access or use the iCloud service for software development or testing after expiration or termination of Your Agreement; however end-users who have Your Applications, Mac App Store applications, or Multi-Platform Software installed and who have a valid end-user account with Apple to use iCloud may continue to access their user-generated documents, private containers and files that You have chosen to store in such end-user’s account via the iCloud Storage APIs or the CloudKit APIs in accordance with the applicable iCloud terms and conditions and these terms. You agree not to interfere with an end-user’s ability to access iCloud (or the end-user’s own user-generated documents, private containers and files) or to otherwise disrupt their use of iCloud in any way and at any time.  With respect to data You store in public containers through the CloudKit APIs (whether generated by You or the end-user), Apple reserves the right to suspend access to or delete such data, in whole or in part, upon expiration or termination of Your Agreement, or as otherwise specified by Apple in the CloudKit dashboard. 

1.3   Your Application is permitted to use the iCloud Storage APIs only for the purpose of storage and retrieval of key value data (e.g., a list of stocks in a finance App, settings for an App) for Your Applications and Multi-Platform Software and for purposes of enabling Your end-users to access user-generated documents and files through the iCloud service. Your Application or Mac App Store application is permitted to use the CloudKit APIs for storing, retrieving, and querying of structured data that You choose to store in public or private containers in accordance with the iCloud Documentation.  You agree not to knowingly store any content or materials via the iCloud Storage APIs or CloudKit APIs that would cause Your Application to violate any of the iCloud terms and conditions or the Program Requirements for Your Applications (e.g., Your Application may not store illegal or infringing materials).  

1.4   You may allow a user to access their user-generated documents and files from iCloud through the use of Your Applications as well as from Multi-Platform Software. However, You may not share key value data from Your Application with other Applications or Multi-Platform Software, unless You are sharing such data among different versions of the same title (e.g., the iPhone version of an Application can share key value data with an iPad or Mac App Store version of the same titled Application), or You have user consent.   
...
1.6   Unless otherwise expressly permitted by Apple in writing, You will not use iCloud, the iCloud Storage APIs, CloudKit APIs, or any component or function thereof, to create, receive, maintain or transmit any sensitive, individually-identifiable health information, including “protected health information” (as such term is defined at 45 C.F.R § 160.103), or use iCloud in any manner that would make Apple (or any Apple Subsidiary) Your or any third party’s “business associate” as such term is defined at 45 C.F.R. § 160.103.  You agree to be solely responsible for complying with any reporting requirements under law or contract arising from Your breach of this Section.
...
2.4   You will not disable or interfere with any warnings, iOS system settings, notices, or notifications that are presented to an end-user of the iCloud service by Apple. 

3.    Your Acknowledgements

You acknowledge and agree that:

3.1   Apple may at any time, with or without prior notice to You (a) modify the iCloud Storage APIs or the CloudKit APIs, including changing or removing any feature or functionality, or (b) modify, deprecate, reissue or republish such APIs.  You understand that any such modifications may require You to change or update Your Applications, Mac App Store applications or Multi-Platform Software at Your own cost. Apple has no express or implied obligation to provide, or continue to provide, the iCloud service and may suspend or discontinue all or any portion of the iCloud service at any time. Apple shall not be liable for any losses, damages or costs of any kind incurred by You or any other party arising out of or related to any such service suspension or discontinuation or any such modification of the iCloud service, iCloud Storage APIs or the CloudKit APIs. 

3.2   The iCloud service is not available in all languages or in all countries and Apple makes no representation that the iCloud service is appropriate or available for use in any particular location. To the extent You choose to provide access to the iCloud service in Your Applications, Mac App Store applications, or Multi-Platform Software through the iCloud Storage APIs or CloudKit APIs (e.g., to store data in a public or private container), You do so at Your own initiative and are responsible for compliance with any applicable laws or regulations.
...
You may use the Pass Type ID only for purposes of digitally signing Your Pass for use with Passbook and/or for purposes of using the APN service with Your Pass.  You may distribute Your Pass Type ID as incorporated into Your Pass in accordance with Section 2 below only so long as such distribution is under Your own trademark or brand. To the extent that You reference a third party’s trademark or brand within Your Pass (e.g., a store coupon for a particular good), You represent and warrant that You have any necessary rights. You agree not to share, provide or transfer Your Pass Type ID to any third party (except for the limited purpose set forth in Attachment 1, Section 5), nor use Your Pass Type ID to sign a third party's pass. 
2.   Pass Distribution; Marketing Permissions
2.1   Subject to the terms of this Agreement, You may distribute Your Passes to end-users by the web, email, or an Application. You understand that Passes must be accepted by such users before they will be loaded into Passbook and that Passes can be removed or transferred by such users at any time.
...
2.4   By distributing Your Passes as permitted in this Agreement, You hereby permit Apple to use (i) screen shots of Your Pass; (ii) trademarks and logos associated with Your Pass; and (iii) Pass Information, for promotional purposes in marketing materials and gift cards, excluding those portions which You do not have the right to use for promotional purposes and which You identify in writing to Apple.  You also permit Apple to use images and other materials that You may provide to Apple, at Apple’s reasonable request, for promotional purposes in marketing materials and gift cards.   


3.    Additional Pass Requirements

3.1   Apple may provide You with templates to use in creating Your Passes, and You agree to choose the relevant template for Your applicable use (e.g., You will not use the boarding pass template for a movie ticket). 

3.2   Passes may only operate and be displayed in Passbook, which is Apple's designated container area for the Pass, or through Passbook on the lock screen of an iOS Product. 

3.3.  Notwithstanding anything else in Section 3.3.9 of the Agreement, with prior user consent, You and Your Pass may share user and/or or device data with Your Application so long as such sharing is for the purpose of providing a service or function that is directly relevant to the use of the Pass and/or Application, or to serve advertising in accordance with Sections 3.3.12 and 3.3.13 of the Agreement. 
...
The following terms are in addition to the terms of the Agreement and apply to any use of the Apple Maps Service in Your Application. 

1.    Use of the Maps Service 

1.1   Your Application may access the Apple Maps Service only via the Map Kit API. You agree not to access the Apple Maps Service or the Map Data other than through the Map Kit API.

1.2   You will use the Apple Maps Service and Map Data only as necessary for providing services and functionality for Your Application.  You agree to use the Apple Maps Service and Map Kit API only as expressly permitted by this Agreement (including but not limited to this Attachment 6) and the Map Kit Documentation, and in accordance with all applicable laws and regulations.
...
2.1    Your Application must not remove, obscure or alter Apple’s or its licensors’ copyright notices, trademarks, or any other proprietary rights or legal notices, documents or hyperlinks that may appear in or be provided through the Apple Maps Service.
...
2.3   You will not copy, modify, translate, create a derivative work of, publish or publicly display the Map Data in any way other than as permitted herein, and You agree not to create or attempt to create a substitute or similar service through use of or access to the Apple Maps Service.

2.4   You will not use the Map Data provided by Apple without using it with a corresponding Apple map.

2.5    Unless otherwise expressly permitted in the Map Kit Documentation, Map Data may not be cached, pre-fetched, or stored by You or Your Application, other than on a temporary and limited basis solely to improve the performance of the Apple Maps Service with Your Application.

2.6   You may not charge any fees to end-users solely for access to or use of the Apple Maps Service through Your Application, and You agree not to sell access to the Apple Maps Service in any other way.
...
3.1   Apple may at any time, with or without prior notice to You (a) modify the Apple Maps Service and/or the Map Kit API, including changing or removing any feature or functionality, or (b) modify, deprecate, reissue or republish the Map Kit API.  You understand that any such modifications may require You to change or update Your Applications at Your own cost. Apple has no express or implied obligation to provide, or continue to provide, the Apple Maps Service and may suspend or discontinue all or any portion of the Apple Maps Service at any time.  Apple shall not be liable for any losses, damages or costs of any kind incurred by You or any other party arising out of or related to any such service suspension or discontinuation or any such modification of the Apple Maps Service or Map Kit API.

3.2   The Apple Maps Service may not be available in all countries or languages, and Apple makes no representation that the Apple Maps Service is appropriate or available for use in any particular location. To the extent You choose to provide access to the Apple Maps Service in Your Applications or through the Map Kit API, You do so at Your own initiative and are responsible for compliance with any applicable laws.

3.3   If the Apple Maps Service is provided to You as a confidential, pre-release service, You will only allow it to be used for testing and development purposes by Your Authorized Developers and only for use on Your Authorized Test Devices, and You will not use the pre-release version of the Apple Maps Service in Your Licensed Applications.  You agree to restrict access to such Authorized Test Devices in accordance with the terms of the Agreement.  
...
1.1   You hereby appoint Apple and Apple Subsidiaries (collectively “Apple”) as: (i) Your agent for the marketing and delivery of the Licensed Applications to end-users located in those countries listed on Exhibit A, Section 1 to this Schedule 1, subject to change; and (ii) Your commissionaire for the marketing and delivery of the Licensed Applications to end-users located in those countries listed on Exhibit A, Section 2 to this Schedule 1, subject to change, during the Delivery Period.  The most current list of App Store countries among which you may select shall be set forth in the iTunes Connect site and may be updated by Apple from time to time.  You hereby acknowledge that Apple will market and make the Licensed Applications available for download by end-users, through one or more App Stores, but for You and on Your behalf. For purposes of this Schedule 1, the following terms apply:

(a) "Licensed Application" includes any additional permitted functionality, content or services provided by You from within a Licensed Application;

(b) “You” shall include iTunes Connect users authorized by You to submit Licensed Applications and associated metadata on Your behalf; and

(c) “end-user” includes individual purchasers as well as eligible users associated with their account via Family Sharing.  For institutional customers, “end-user” shall mean the individual authorized to use the Licensed Application as well as authorized institutional customers approved by Apple, such as educational institutions, which may acquire the Licensed Applications for use by their end-users.  The most current list of App Store countries among which you may select shall be set forth in the iTunes Connect site and may be updated from time to time.
...
2.1   You will deliver to Apple, at Your sole expense, using the iTunes Connect site or other mechanism provided by Apple, the Licensed Applications, Licensed Application Information and associated metadata, in a format and manner prescribed by Apple, as required for the delivery of the Licensed Applications to end-users in accordance with this Schedule 1.  Metadata You deliver to Apple under this Schedule 1 will include:  (i) the title and version number of each of the Licensed Applications; (ii) the countries You designate, in which You wish Apple to allow end-users to download those Licensed Applications; (iii) any copyright or other intellectual property rights notices; (iv) Your privacy policy, if any; and (v) Your end-user license agreement (“EULA”), if any, in accordance with Section 3.2 of this Schedule 1.
...
3.5   You may offer in-app subscriptions for free in select territories using the In-App Purchase API subject to the terms of this Schedule 1, provided that the Licensed Application is Newsstand-enabled pursuant to section 3.7 below and You clearly and conspicuously disclose to users the following information regarding Your in-app subscription:

•      Title of publication or service
•      Subscription may be discontinued at any time by removing app from device
•      Links to Your Privacy Policy and Terms of Use

3.6   To the extent you promote and offer in-app subscriptions, You must do so in compliance with all legal and regulatory requirements.
...
3.8   Licensed Applications offering subscription services under this Schedule 1 must be included in Apple’s Newsstand program provided that, in addition to the requirements set forth in paragraphs 3.5, 3.6 and 3.7, You:
...
You appoint iTunes S.a.r.l. as Your commissionaire pursuant to Article 91 of the Luxembourg Code de commerce for the marketing and end-user download of the Licensed Applications by end-users located in the following countries, as updated from time to time via the iTunes Connect site:
...
2.  Scope of License:  The license granted to the end-user for the Licensed Application must be limited to a non-transferable license to use the Licensed Application on any iOS Products that the end-user owns or controls and as permitted by the Usage Rules set forth in the App Store Terms of Service, except that such Licensed Application may be accessed, acquired, and used by other accounts associated with the purchaser via Family Sharing.
